        ...
        <div className="container mx-auto p-4">
            ...
            <div>
                <div className="flex justify-around">
                    <a href="https://www.instagram.com/__.raulpr__/?hl=es" target="_blank" ><i className="fa-brands fa-instagram text-3xl" ></i></a>
                    <a href="https://github.com/RaulPovedano" target="_blank"><i className="fa-brands fa-github text-3xl"> </i></a>
                    <a href="https://www.linkedin.com/in/raul-povedano-72b12023a/" target="_blank"><i className="fa-brands fa-linkedin text-3xl"></i></a>
                </div>
            </div>
            </footer>
        </div>
