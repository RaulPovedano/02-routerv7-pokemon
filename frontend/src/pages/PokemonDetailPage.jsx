    ...
    <div className="container mx-auto p-4">
      <div className="max-w-2xl mx-auto bg-blue rounded-lg shadow-lg p-6">
        ...
        <div className="grid grid-cols-2 gap-6">
          <div>
            <h2 className="text-xl text-blue-600 font-semobold mb-2">Estadisticas</h2>
          ...
          <div>
            <h2 className="text-xl text-blue-600 font-semobold mb-2">Tipos</h2>
            <div key={pokemon.types.name}>
              {pokemon.types.map((type) => (
                <span key={type.type.name} className="inline-block bg-gray-200 rounded-xl px-3 text-sm font-semibold text-gray-700 mr-2">
                  {type.type.name}
                </span>
              ))}
            </div>
          ...
          <button 
            className="mt-4 text-center bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-xl"
